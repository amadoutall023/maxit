    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        <div class="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-8 form-container">
            ...
            <form class="space-y-6" action="/compte" method="post">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="text-center mb-8">
                    <a href="/comptePrincipal" class="text-orange-500 hover:text-orange-400 font-medium transition-colors duration-200 underline decoration-orange-500/50 hover:decoration-orange-400/70 underline-offset-4">
                        Créer un compte
                    </a>
                </div>
                ...
                <!-- Message d'erreur -->
                <div id="errorMessage" class="hidden mt-4 p-3 bg-red-500/20 border border-red-500/50 rounded-lg text-red-300 text-sm text-center">
                    Veuillez entrer un numéro de téléphone valide.
                </div>

                <!-- Message de succès -->
                <div id="successMessage" class="hidden mt-4 p-3 bg-green-500/20 border border-green-500/50 rounded-lg text-green-300 text-sm text-center">
